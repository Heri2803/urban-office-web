...
<div x-data="{ isVisible: false, fotoProperti: null }" x-init="setTimeout(() => isVisible = true, 100)" class="flex min-h-screen bg-gray-50">
    ...
    <div class="transition-all duration-500 ease-out"
        ...
        <input type="text" name="namaLengkap" value="{{ old('namaLengkap') }}"
               ...
               class="w-full px-4 py-3 border-2 {{ $errors->has('namaLengkap') ? 'border-red-500' : 'border-gray-300' }} rounded-lg focus:border-orange-500 focus:ring focus:ring-orange-200 transition-all duration-200 text-gray-800 font-medium placeholder-gray-500 hover:border-gray-400"/>
        @error('namaLengkap')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 transition-all duration-500 ease-out"
        ...
        <div>
            ...
            <input type="email" name="alamatEmail" value="{{ old('alamatEmail') }}"
                   ...
                   class="w-full px-4 py-3 border-2 {{ $errors->has('alamatEmail') ? 'border-red-500' : 'border-gray-300' }} rounded-lg focus:border-orange-500 focus:ring focus:ring-orange-200 transition-all duration-200 text-gray-800 font-medium placeholder-gray-500 hover:border-gray-400"/>
            @error('alamatEmail')
                <p class="text-sm text-red-500 mt-1">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="text" name="alamatProperti" value="{{ old('alamatProperti') }}"
                   ...
                   class="w-full px-4 py-3 border-2 {{ $errors->has('alamatProperti') ? 'border-red-500' : 'border-gray-300' }} rounded-lg focus:border-orange-500 focus:ring focus:ring-orange-200 transition-all duration-200 text-gray-800 font-medium placeholder-gray-500 hover:border-gray-400"/>
            @error('alamatProperti')
                <p class="text-sm text-red-500 mt-1">{{ $message }}</p>
            @enderror
        </div>
    </div>
    ...
    <div class="transition-all duration-500 ease-out"
        ...
        <input type="text" name="nik" value="{{ old('nik') }}"
               ...
               class="w-full px-4 py-3 border-2 {{ $errors->has('nik') ? 'border-red-500' : 'border-gray-300' }} rounded-lg focus:border-orange-500 focus:ring focus:ring-orange-200 transition-all duration-200 text-gray-800 font-medium placeholder-gray-500 hover:border-gray-400"/>
        @error('nik')
            <p class="text-sm text-red-500 mt-1">{{ $message }}</p>
        @enderror
    </div>
    ...
    <div class="transition-all duration-500 ease-out"
        ...
        <div class="relative">
            ...
            <div class="border-2 border-dashed {{ $errors->has('fotoProperti') ? 'border-red-500' : 'border-gray-300' }} rounded-lg p-8 md:p-12 text-center bg-gray-50 hover:bg-gray-100 hover:border-gray-400 transition-all duration-200">
