...
<div class="space-y-6" x-data="dashboardData()">
    ...
    <section class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6">
        {{-- Total Transaksi --}}
        <div class="bg-gradient-to-br from-orange-500 to-orange-600 p-6 rounded-2xl shadow-sm text-white">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-blue-100 text-sm font-medium">Total Transaksi</p>
                    <p class="text-3xl font-bold mt-2" x-text="stats.totalTransactions"></p>
                    <p class="text-blue-100 text-xs mt-1">Bulan ini</p>
                </div>
        ...
        <div class="bg-gradient-to-br from-orange-500 to-orange-600 p-6 rounded-2xl shadow-sm text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold mt-2" x-text="formatCurrency(stats.totalRevenue)"></p>
                    <p class="text-green-100 text-xs mt-1">Bulan ini</p>
                </div>
                <div class="bg-white/20 p-3 rounded-xl">
                    <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div class="bg-gradient-to-br from-orange-500 to-orange-600 p-6 rounded-2xl shadow-sm text-white">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-purple-100 text-sm font-medium">Lokasi Aktif</p>
                    <p class="text-3xl font-bold mt-2" x-text="stats.activeLocations"></p>
                    <p class="text-purple-100 text-xs mt-1">Tersedia</p>
                </div>
                <div class="bg-white/20 p-3 rounded-xl">
                    <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div class="bg-gradient-to-br from-orange-500 to-orange-600 p-6 rounded-2xl shadow-sm text-white">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-orange-100 text-sm font-medium">Booking Pending</p>
                    <p class="text-3xl font-bold mt-2" x-text="stats.pendingBookings"></p>
                    <p class="text-orange-100 text-xs mt-1">Perlu review</p>
                </div>
                <div class="bg-white/20 p-3 rounded-xl">
                    <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
                ...
                <tbody class="divide-y divide-gray-200">
                    <template x-for="transaction in recentTransactions" :key="transaction.id">
                        <tr class="hover:bg-gray-50 transition">
                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-600" x-text="transaction.date"></td>
                            <td class="px-4 py-4 whitespace-nowrap">
                                <span class="text-sm font-medium text-gray-900" x-text="transaction.service"></span>
                            </td>
                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-600" x-text="transaction.customer"></td>
                            <td class="px-4 py-4 whitespace-nowrap text-right text-sm font-semibold text-gray-900" x-text="formatCurrency(transaction.amount)"></td>
...
function dashboardData() {
    return {
        ...
        selectLocation(location) {
            ...
            // TODO: Reload chart data berdasarkan lokasi
        },
            ...
            this.chart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: this.chartData.monthly.data,
