...
<div x-data="{ openProfileDropdown: false }" class="px-4 md:px-6 py-4 bg-white border-b border-gray-200">
    <div class="flex items-center justify-between">
        ...
        <div class="relative">
            <button 
                ...
                {{-- Profile Info (Hidden di layar kecil) --}}
                ...
                <div class="relative">
                    ...
                    @else
                        <div class="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-700 font-semibold border-2 border-gray-200">
            ...
            <div x-show="openProfileDropdown"
                ...
                <div class="px-4 py-3 bg-gray-50 border-b border-gray-100">
                    ...
                    <p class="text-xs text-gray-500">{{ auth()->user()->email ?? 'admin@email.com' }}</p>
                </div>
