{{-- resources/views/layouts/publicpage/contract-verify.blade.php --}}
<!DOCTYPE html>
<html lang="id">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Verifikasi Kontrak - {{ $contract->contract_number }}</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="min-h-screen flex items-center justify-center p-4" style="background-color: #FFF7F0;">
        ...
        <div class="bg-white rounded-2xl overflow-hidden" style="border: 0.5px solid #F97316;">
            ...
            <div class="px-8 pt-8 pb-7 text-center" style="background-color: #EA580C;">
                ...
                <div class="flex items-center justify-center gap-2 mb-1">
                    ...
                    <h1 class="text-white font-semibold" style="font-size: 18px;">Dokumen Terverifikasi</h1>
                </div>
            ...
            <div class="px-8 py-6">
                ...
                {{-- Badge Status --}}
                @php
                    $badgeStyle = match($contract->status) {
                        ...
                        'renewed'    => 'background:#EFF6FF; border-color:#BFDBFE; color:#1D4ED8;',
                        default      => 'background:#F9FAFB; border-color:#E5E7EB; color:#374151;',
                    };
                    $badgeDot = match($contract->status) {
                        'active'     => '#16A34A',
                        'expired'    => '#F97316',
                        'terminated' => '#DC2626',
                        'renewed'    => '#2563EB',
                ...
                <div class="space-y-0">
                    ...
                    <div class="flex justify-between items-start py-3" style="border-bottom: 0.5px solid #F3F4F6;">
                        <span class="text-sm" style="color: #6B7280; flex-shrink: 0;">Nomor Kontrak</span>
                    ...
                    <div class="flex justify-between items-center py-3" style="border-bottom: 0.5px solid #F3F4F6;">
                        <span class="text-sm" style="color: #6B7280; flex-shrink: 0;">Tanggal Mulai</span>
                        <span class="text-sm font-medium text-right ml-4" style="color: #111827;">
                    ...
                    <div class="flex justify-between items-center py-3" style="border-bottom: 0.5px solid #F3F4F6;">
                        <span class="text-sm" style="color: #6B7280; flex-shrink: 0;">Tanggal Berakhir</span>
                        <span class="text-sm font-medium text-right ml-4" style="color: #111827;">
                    ...
                    <div class="flex justify-between items-center py-3">
                        <span class="text-sm" style="color: #6B7280; flex-shrink: 0;">Tanggal Kontrak</span>
                        <span class="text-sm font-medium text-right ml-4" style="color: #111827;">
